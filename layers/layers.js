...
var format_Segnalazioni_4 = new ol.format.GeoJSON();
var features_Segnalazioni_4 = format_Segnalazioni_4.readFeatures(json_Segnalazioni_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Segnalazioni_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Segnalazioni_4.addFeatures(features_Segnalazioni_4);
var lyr_Segnalazioni_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Segnalazioni_4, 
                style: style_Segnalazioni_4,
                popuplayertitle: 'Segnalazioni',
                interactive: true,
                title: '<img src="styles/legend/Segnalazioni_4.png" /> Segnalazioni'
            });
...
lyr_GoogleSatellite_0.setVisible(true);lyr_comunicazione1_1.setVisible(true);lyr_acqua5_2.setVisible(true);lyr_curve_di_livello_3.setVisible(true);lyr_Segnalazioni_4.setVisible(true);lyr_Perimetro_5.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,group_Comunicazione,group_Acqua,group_Orografia,lyr_Segnalazioni_4,lyr_Perimetro_5];
...
lyr_Segnalazioni_4.set('fieldAliases', {'id segnala': 'id segnala', 'nome segna': 'nome segna', 'tipo segna': 'tipo segna', 'data segna': 'data segna', 'via': 'via', 'foto': 'foto', 'descrizion': 'descrizion', 'coordinate': 'coordinate', 'foto1': 'foto1', 'foto2': 'foto2', 'numero seg': 'numero seg', });
...
lyr_Segnalazioni_4.set('fieldImages', {'id segnala': 'TextEdit', 'nome segna': 'TextEdit', 'tipo segna': 'TextEdit', 'data segna': 'DateTime', 'via': 'TextEdit', 'foto': 'ExternalResource', 'descrizion': 'TextEdit', 'coordinate': 'TextEdit', 'foto1': 'ExternalResource', 'foto2': 'ExternalResource', 'numero seg': 'TextEdit', });
...
lyr_Segnalazioni_4.set('fieldLabels', {'id segnala': 'inline label - always visible', 'nome segna': 'no label', 'tipo segna': 'no label', 'data segna': 'no label', 'via': 'no label', 'foto': 'header label - always visible', 'descrizion': 'no label', 'coordinate': 'no label', 'foto1': 'no label', 'foto2': 'no label', 'numero seg': 'no label', });
