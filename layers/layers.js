...
lyr_Segnalazioni_4.set('fieldAliases', {'id segnala': 'id segnala', 'nome segna': 'nome segna', 'tipo segna': 'tipo segna', 'data segna': 'data segna', 'via': 'via', 'foto': 'foto', 'descrizion': 'descrizion', 'coordinate': 'coordinate', });
...
lyr_Segnalazioni_4.set('fieldImages', {'id segnala': 'TextEdit', 'nome segna': 'TextEdit', 'tipo segna': 'TextEdit', 'data segna': 'DateTime', 'via': 'TextEdit', 'foto': 'ExternalResource', 'descrizion': 'TextEdit', 'coordinate': 'TextEdit', });
...
lyr_Segnalazioni_4.set('fieldLabels', {'id segnala': 'inline label - always visible', 'nome segna': 'no label', 'tipo segna': 'no label', 'data segna': 'no label', 'via': 'no label', 'foto': 'header label - always visible', 'descrizion': 'no label', 'coordinate': 'no label', });
